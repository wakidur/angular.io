...
@Component({
  selector: "app-local-storage-workout",
  templateUrl: "./local-storage-workout.component.html",
  styles: []
})
export class LocalStorageWorkoutComponent implements OnInit, OnDestroy {
